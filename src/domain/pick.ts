...
/** A source of 32-bit numbers. The app passes the platform's; a test passes its own. */
export type Random = () => number;

const TOP = 2 ** 32;

/** The platform's cryptographic source (ADR 4). */
 ...
 *
 * Taking the remainder of a 32-bit number favours the first few values whenever the range
 * does not divide evenly, so values in the uneven tail are drawn again.
 */
